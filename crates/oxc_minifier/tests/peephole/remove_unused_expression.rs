...
fn test_drop_write_only_property_assignments_by_default() {
    ...
    test_options("var o = {}; o.x = 1;", "", &options);
    test_options("var o = []; o.x = 1;", "", &options);
    test_options("var o = () => {}; o.x = 1;", "", &options);
    test_options("var o = function() {}; o.x = 1;", "", &options);
    test_options("var o = class {}; o.x = 1;", "", &options);
    test_options("function o() {} o.x = 1;", "", &options);

    // Impure RHS: the RHS is hoisted in place, the write dropped.
    test_options("var o = {}; o.x = impure();", "impure();", &options);

    // Value position: a plain assignment's value IS the RHS value.
    test_options("var o = {}; use(o.x = impure());", "use(impure());", &options);

    // Computed keys: literal string/number keys are safe...
    test_options("var o = {}; o['x'] = 1;", "", &options);
    test_options("var o = {}; o[0] = 1;", "", &options);
    ...
    test_same_options("var o = {}; o[k()] = 1;", &options);
    test_same_options("var o = {}; o[b] = 1;", &options);
    test_same_options("var o = {}; o.__proto__ = x;", &options);
    test_options("var o = {}; o['__proto__'] = x;", "var o = {}; o.__proto__ = x;", &options);

    // Escapes: any non-member-write use of the binding blocks the drop.
    test_options("var o = {}; o.x = 1; use(o);", "var o = {}; o.x = 1, use(o);", &options);
    test_same_options("var o = {}; o.x = o;", &options);
    test_same_options("var o = {}; o.x = () => o;", &options);
    test_same_options("export var o = {}; o.x = 1;", &options);
    ...
    test_same_options("var o = {}; o.x += 1;", &options);
    test_options("var o = {}; o.y ||= 2; o.x = 1;", "var o = {}; o.y ||= 2, o.x = 1;", &options);
    test_options("var o = {}; o.x++; o.y = 1;", "var o = {}; o.x++, o.y = 1;", &options);
    ...
    test_options(
        "var o = {}; o.x = evil; o.y = o.y + 1;",
        "var o = {}; o.x = evil, o.y += 1;",
        &options,
    );

    // Chained-write base (hazard): dropping `a.b = {}` while `a.b.c = 1`
    // survives would throw at runtime.
    test_options("var a = {}; a.b = {}; a.b.c = 1;", "var a = {}; a.b = {}, a.b.c = 1;", &options);
    ...
    test_options("var o = {}; o.x = 1; delete o.x;", "var o = {}; delete o.x;", &options);
    // Chained delete reads the intermediate object — everything stays.
    test_options(
        "var a = {}; a.b = {}; delete a.b.c;",
        "var a = {}; a.b = {}, delete a.b.c;",
        &options,
    );
    ...
    test_same_options("class A { static set foo(v) { console.log(v); } } A.foo = 1;", &options);
    test_same_options("var o = { set x(v) { console.log(v) } }; o.x = 1;", &options);
    ...
    for (form, sep) in [
        ...
        for key in ["caller", "arguments", "name", "length"] {
            test_same_options(&format!("{form}{sep} o.{key} = 1;"), &options);
        }
    }

    // A class's `prototype` is non-writable (throws), so it stays. A plain
    // function's `prototype` IS writable, so that write still drops.
    test_same_options("var o = class {}; o.prototype = 1;", &options);
    test_same_options("class o {} o.prototype = 1;", &options);
    test_options("var f = function() {}; f.prototype = {};", "", &options);
    test_options("function f() {} f.prototype = {};", "", &options);

    // Array `length`: `a.length = -1` throws a `RangeError`; `a.length = {...}`
    // runs a `valueOf` coercion. Both kept; a computed string key counts too.
    test_same_options("var a = []; a.length = -1;", &options);
    test_same_options("var a = []; a.length = { valueOf() { g(); } };", &options);
    test_options("var a = []; a['length'] = 1;", "var a = []; a.length = 1;", &options);
    // A numeric index write is an ordinary array write — still drops.
    test_options("var a = []; a[0] = 1;", "", &options);

    // `name` / `length` on an object literal are ordinary writable props: the
    // denylist is kind-scoped, so Object-kind bases still drop.
    test_options("var o = {}; o.length = 5;", "", &options);
    test_options("var o = {}; o.name = 'n';", "", &options);
    ...
    test_same_options("export class C { #x; m() { var o = {}; o.#x = 1; } }", &options);
    ...
    test_same_options("class o { static { g(); } } o.x = 1;", &options);
    test_same_options("class o { static get foo() { return 1; } } o.foo = 1;", &options);
    test_same_options("@dec class o {} o.x = 1;", &options);
